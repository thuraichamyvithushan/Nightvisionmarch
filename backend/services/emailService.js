  ...
  const submissionDetails = (request) => `
    <div style="padding: 30px 40px; background-color: ${containerBg};">
      ...
      <table style="width: 100%; border-collapse: separate; border-spacing: 0;">
        ...
        <tr><td style="padding: 12px 0; border-bottom: 1px solid #f8fafc; color: ${textLight}; font-size: 14px; font-weight: 500;">Postal Address</td><td style="padding: 12px 0; border-bottom: 1px solid #f8fafc; font-weight: 700; text-align: right; color: ${textDark};">${_esc(request.address)}</td></tr>
        ...
        <tr><td style="padding: 12px 0; border-bottom: 1px solid #f8fafc; color: ${textLight}; font-size: 14px; font-weight: 500;">Interest</td><td style="padding: 12px 0; border-bottom: 1px solid #f8fafc; font-weight: 700; text-align: right; color: ${textDark};">${_esc(request.marketingInterest || 'No')}</td></tr>
        ${request.marketingExperience ? `<tr><td style="padding: 12px 0; border-bottom: 1px solid #f8fafc; color: ${textLight}; font-size: 14px; font-weight: 500;">Marketing Experience</td><td style="padding: 12px 0; border-bottom: 1px solid #f8fafc; font-weight: 700; text-align: right; color: ${textDark};">${_esc(request.marketingExperience)}</td></tr>` : ''}
