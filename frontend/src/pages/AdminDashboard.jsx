    ...
    return (
        <div className="max-w-7xl mx-auto space-y-12 animate-fade-in">
            <header className="text-center sm:text-left">
                <h1 className="text-4xl font-extrabold bg-gradient-to-r from-sky-600 to-sky-800 bg-clip-text text-transparent mb-2">Admin Dashboard</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div
                    ...
                    className="bg-white/95 backdrop-blur-lg p-10 rounded-[2.5rem] shadow-2xl border border-white/20 cursor-pointer transition-all duration-500 hover:scale-[1.03] hover:shadow-[0_20px_60px_rgba(14,165,233,0.15)] flex flex-col items-center justify-center text-center group relative overflow-hidden"
                >
                    <div className="absolute bottom-0 left-0 w-32 h-32 bg-sky-500/5 rounded-full -ml-16 -mb-16 transition-transform duration-500 group-hover:scale-150"></div>
                    <div className="p-5 rounded-3xl mb-6 shadow-xl transition-all duration-500 group-hover:-rotate-6 group-hover:scale-110" style={{ background: 'linear-gradient(135deg, #0284c7 0%, #075985 100%)' }}>
