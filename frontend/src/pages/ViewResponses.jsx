    ...
    return (
        <>
            ...
            {isViewModalOpen && selectedRequest && (
                <div className="fixed inset-0 z-[999] flex items-start justify-center p-6 sm:p-12 pt-24 bg-gray-900/40 backdrop-blur-sm animate-fade-in overflow-y-auto">
                    <div className="bg-white w-full max-w-4xl my-8 rounded-[2.5rem] shadow-2xl border border-gray-100 overflow-hidden relative">
            ...
            {isDeleteModalOpen && (
                <div className="fixed inset-0 z-[999] flex items-start justify-center p-6 pt-24 bg-gray-900/40 backdrop-blur-sm animate-fade-in overflow-y-auto">
                    <div className="bg-white w-full max-w-sm my-8 rounded-[2rem] shadow-2xl border border-gray-100 overflow-hidden">
